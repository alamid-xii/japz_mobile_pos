  ...
  const loadEmployee = async () => {
    try {
      ...
      setFormData({
        ...
        assignedStationId: employee.assignedStationId,
            ...
            {(['active', 'inactive'] as const).map((status) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  paddingVertical: Sizes.spacing.sm,
                  borderRadius: 20,
                  backgroundColor: formData.status === status ? '#FFCE1B' : Colors.light.card,
                  borderWidth: 1,
                  borderColor: formData.status === status ? '#FFCE1B' : Colors.light.border,
                }}
              ...
              >
                <Text
                  style={{
                    fontSize: Sizes.typography.sm,
                    fontWeight: '500',
                    color: formData.status === status ? '#030213' : Colors.light.foreground,
                    textTransform: 'capitalize',
                  }}
                >
                  {status}
